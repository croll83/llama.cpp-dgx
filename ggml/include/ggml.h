...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TURBO3_TCQ = 205, // TurboQuant 3-bit KV cache: TCQ (Trellis-Coded Quantization)
        GGML_TYPE_TURBO2_TCQ = 206, // TurboQuant 2-bit KV cache: TCQ (k=2, L=8, 256 states)
        GGML_TYPE_COUNT   = 207,
    };
